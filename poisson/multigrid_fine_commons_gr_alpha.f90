...
subroutine multigrid_fine_gr(ilevel,icount)
   ...
   if(ilevel>levelmin)then
      call make_initial_phi(ilevel,icount)  ! Interpolate phi down -- Phi now gets replaces by the corresponding field to solve
   else
...
! the previous routine is only called once
