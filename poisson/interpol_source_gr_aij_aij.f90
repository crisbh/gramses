subroutine interpol_gr_aij_aij(ind_cell,phi_int,ncell,ilevel,icount)
  use amr_commons
  ...
  do ind=1,twotondim
     ...
     do ind_average=1,twotondim
        ...
        do i=1,ncell
           ...
           if (indice==0) then
              add=coeff*gr_mat(ind_cell(i),4)
           else
              add=coeff*gr_mat(indice     ,4)
           endif
...
end subroutine interpol_gr_aij_aij
